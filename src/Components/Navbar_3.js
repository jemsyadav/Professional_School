          ...
          <ul class="navbar-nav mb-2 mb-lg-0" style={{ textAlign: "center" }}>
            <li class="nav-item">
              <a
                ...
                aria-current="page"
                href="/controlpannelhome"
              >
                Home
              </a>
            </li>
            <li class="nav-item">
              <a class=" nav-link text-black" href="/faculity">
                Faculity
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link text-black" href="/students">
                Students
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link text-black" href="/course">
                Course
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link text-black" href="/registation">
                Registation
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link text-black" href="/announcments">
                Announcements
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link text-black" href="/form&faq">
                Forum & faq
              </a>
            </li>
            <li class="nav-item">
